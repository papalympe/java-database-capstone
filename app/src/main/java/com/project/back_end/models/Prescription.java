...
public class Prescription {
    ...
    // Reference to appointment ID (required)
    @NotNull(message = "Appointment ID cannot be null")
    private Long appointmentId;

    // Medication name (required, 3-100 characters)
    ...
    // Dosage details (required, 3-20 characters)
    @NotNull(message = "Dosage cannot be null")
    @Size(min = 3, max = 20, message = "Dosage must be between 3 and 20 characters")
    private String dosage;

    // Optional doctor's notes (max 200 characters)
